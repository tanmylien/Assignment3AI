...
Implemented in main.py (line 51-56), where user age input is checked using a _try-except_ block to catch non-numeric values, which prevents the program from crashing.<br/>
<br/>
**Enumeration:** <br/>
